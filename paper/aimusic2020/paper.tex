...
%
\author{Carmine Emanuele Cella\inst{1}\and Luke Dzwonczyk\inst{1}\and Alejandro Saldarriaga-Fuertes\inst{1}\and Hongfu Liu\inst{2}\and Helene-Camille Crayencour\inst{3}}
%
...
\institute{University of California, Berkeley \and InstituteB\\ \email{ , dz.luke@berkeley.edu, }}
